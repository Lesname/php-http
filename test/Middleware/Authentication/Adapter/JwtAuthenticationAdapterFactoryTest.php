...
use LessHttp\Middleware\Authentication\Adapter\JwtAuthenticationAdapterFactory;
use PHPUnit\Framework\TestCase;
use Psr\Container\ContainerInterface;

/**
 * @covers \LessHttp\Middleware\Authentication\Adapter\JwtAuthenticationAdapterFactory
 */
